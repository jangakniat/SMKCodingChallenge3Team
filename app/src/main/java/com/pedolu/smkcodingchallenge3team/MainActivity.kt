...
import com.pedolu.smkcodingchallenge3team.adapter.ViewPagerAdapter
import kotlinx.android.synthetic.main.activity_main.*


class MainActivity : AppCompatActivity() {
    private val menuTeks = arrayOf("Global", "Lokal", "Indonesia", "Relawan")
    private val menuIcon = arrayOf(
        R.drawable.ic_global, R.drawable.ic_local,
        R.drawable.ic_home, R.drawable.ic_volunteer
    )
